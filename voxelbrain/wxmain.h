...
//*** Imported verbatim from the original main.h ***//
...
class MainFrame: public wxFrame
{
  ...
  main_module mm; //where all thing happen; TODO: refactor 
...
public:
    static MainFrame * Create(MainFrame *parentFrame, bool isCloneWindow = false);
