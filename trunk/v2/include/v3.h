...
#include "math.h"
  ...
  //transform from integer to float and back; scaling+transposing. 
  // V3f.x = V3i.x*unit.x+zero.x
  // V3f.y = V3i.y*unit.y+zero.y
  // V3f.z = V3i.z*unit.z+zero.z
// and vice versa.
  class Vtr{
  public:
...
///pretty-print contents of a vector.
